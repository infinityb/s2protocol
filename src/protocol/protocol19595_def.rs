...
pub static TYPEINFOS: &'static [TypeInfo] = &[
    ...
    TypeInfo::Array { bounds: IntBounds { min: 0, bitlen: 5 }, typeid: 36 },
    TypeInfo::Struct {
        fields: &[
            ("m_lockTeams", 26, -11),
    ...
    TypeInfo::Array { bounds: IntBounds { min: 0, bitlen: 5 }, typeid: 52 },
    TypeInfo::Struct {
        fields: &[
            ("m_phase", 12, -9),
            ("m_maxUsers", 7, -8),
    ...
    TypeInfo::Int { bounds: IntBounds { min: 0, bitlen: 18 } },
    ...
    TypeInfo::Struct {
        fields: &[
            ...
            ("m_snapshotControlPlayerId", 47, -3),
            ("m_snapshotUpkeepPlayerId", 47, -2),
    ...
    TypeInfo::Array { bounds: IntBounds { min: 0, bitlen: 8 }, typeid: 10 },
    TypeInfo::Choice {
        bounds: IntBounds { min: 0, bitlen: 2 },
        types: phf_map! {
            0_u32 => ("None", 75),
    ...
    TypeInfo::Array { bounds: IntBounds { min: 0, bitlen: 8 }, typeid: 84 },
    ...
    TypeInfo::Array { bounds: IntBounds { min: 0, bitlen: 3 }, typeid: 67 },
    TypeInfo::Struct {
        fields: &[
            ("m_recipientId", 1, -2),
            ("m_resources", 92, -1),
    ...
    TypeInfo::Struct {
        fields: &[
            ...
            ("m_targetUnitSnapshotUpkeepPlayerId", 47, -3),
            ("m_targetUnitSnapshotControlPlayerId", 47, -2),
            ("m_targetPoint", 96, -1),
        ],
    },
    TypeInfo::Struct {
